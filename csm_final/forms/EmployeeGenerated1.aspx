<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeGenerated1.aspx.cs" Inherits="testkpi.EmployeeGenerated1" %>
...
<body>
    ...
    <table>
        ...
        <tr>
          <td class="style3">&nbsp; </td>
          <td class="style2"><asp:Label ID="Label2" runat="server" Text="EMPLOYEMENT LEVEL GENERATED"></asp:Label></td>
        </tr>
        <tr>
         <td colspan='2'>
