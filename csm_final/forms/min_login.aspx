<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="min_login.aspx.cs" Inherits="csm_final.forms.ministry_login" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <asp:SqlDataSource ID="SQL_user" runat="server" 
            ...
            SelectCommand="SELECT * FROM [MIN_USER]"></asp:SqlDataSource>
            </body>
</html> 